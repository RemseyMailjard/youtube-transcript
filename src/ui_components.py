...
def render_hero() -> None:
    st.markdown(
        """
        <div style="background:linear-gradient(135deg,#FF0000 0%,#CC0000 100%);padding:2.5rem 2rem 2rem;text-align:center;margin:-1rem -1rem 2rem -1rem;">
            <div style="color:#FFFFFF;font-size:2.8rem;font-weight:900;margin:0 0 0.5rem 0;letter-spacing:-0.03em;font-family:Inter,sans-serif;">YouTube to Transcript</div>
            <div style="color:rgba(255,255,255,0.9);font-size:1.05rem;margin:0;line-height:1.6;font-family:Inter,sans-serif;">Generate YouTube Transcript for FREE.<br>
